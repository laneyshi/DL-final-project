...
MAX_EPISODES = 1000 #
MAX_EP_STEPS = 160  # iteration in each episodes (above)
DECADE_EPIS = 1500
...
LR_C = 0.00008 # learning rate for critic
...
parameters[1] = [1, 1, 2]
parameters[2] = [8, -27, 6, 6, 15, 30]
parameters[3] = [1, 0.01, 0.05]

parameters[4] = [[3, 4], [0, -5], [-3, 4]]
parameters[5] = [[3, -1], [-3, -1], [-1, 1], [2, 3]]

mean_para = [[], []]
mean_para[0] = [-3, -3, -3, -3]
mean_para[1] = [0.03, 0.03, 0.03, 0.03]
...
Compare = save_compare.Compare_numerical(ep_reward, beam, classifcation, actor_loss, critic_loss, PRE_PUN)

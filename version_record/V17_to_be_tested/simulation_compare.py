...
parameters[1] = [5, 5, 20]
parameters[2] = [5, -28, 5.5, 5.5, 15, 30]
parameters[3] = [2, 0.1, 0.05]

parameters[4] = [[3.5, 2.5], [-1, -4], [-2, 3]]
parameters[5] = [[1, 1.5], [0.5, 2.5], [-1, 0], [0.5, -1]]
...
for i in range(MAX_EPISODES):
    ...
    for j in range(MAX_EP_STEPS):
        ...
        throughput = (50 / 3) * s1[0:CU_num] + 50
        ...
        throughput = (50 / 3) * s2[0:CU_num] + 50
        ...
        if j == MAX_EP_STEPS - 1:
            ...
            for step in range(MAX_EP_STEPS):
                ...
                pdqn.store_transition(a1, 10 * s1, parameter_a1, r1 / 1, 10 * s_1)
                double_pdqn.store_transition(a2, 10 * s2, parameter_a2, r2 / 1, 10 * s_2)

...
parameters[1] = [0.5, 0.5, 0.5, 0.5, 0.5]
parameters[2] = [8, -25, 18, 18, 45]
parameters[3] = [30, 0.05, 0.5]
...
double_pdqn = my.Double_PDQN(state_dim, cla_dim, CU_num, EU_num, Antenna_num, HYPER_PARA, 0)
pdqn = my.PDQN(state_dim, cla_dim, CU_num, EU_num, Antenna_num, HYPER_PARA, 0)

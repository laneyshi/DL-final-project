...
parameters[1] = [1, 1, 2.5, 2.5, 2.5]
parameters[2] = [8, -25, 18, 18, 45]
parameters[3] = [5, 0.5, 0.5]
...
s2 = s1
pre_reward_cal1 = [20, a, parameter_a, 0]
...
for i in range(MAX_EPISODES):
    ...
    for j in range(MAX_EP_STEPS):
        ...
        # this_buff1[0].append(a1)
        # this_buff2[0].append(a2)
        # this_buff1[1].append(s1)
        # this_buff2[1].append(s2)
        # this_buff1[2].append(parameter_a1)
        # this_buff2[2].append(parameter_a2)
        # this_buff1[4].append(s_1)
        # this_buff2[4].append(s_2)
        ...
        # this_buff1[3].append(r1)
        # this_buff2[3].append(r2)
        #
        # this_buff1[5].append(reward_cal1[0])
        # this_buff2[5].append(reward_cal2[0])
        ...
        if j == MAX_EP_STEPS - 1:
            ...
            #     this_buff1[3][step] = this_buff1[3][step] + -1 * (this_buff1[5][step] - ep_reward[0][i][1])
            #     this_buff2[3][step] = this_buff2[3][step] + -1 * (this_buff2[5][step] - ep_reward[1][i][1])
            #
            #     a1 = this_buff1[0][step]
            #     s1 = this_buff1[1][step]
            #     parameter_a1 = this_buff1[2][step]
            #     r1 = this_buff1[3][step]
            #     s_1 = this_buff1[4][step]
            #
            #     a2 = this_buff2[0][step]
            #     s2 = this_buff2[1][step]
            #     parameter_a2 = this_buff2[2][step]
            #     r2 = this_buff2[3][step]
            #     s_2 = this_buff2[4][step]
            #
            #     pdqn.store_transition(a1, s1, parameter_a1, r1, s_1)
            #     double_pdqn.store_transition(a2, s2, parameter_a2, r2, s_2)
            #
            # ep_reward[0][i][0] = np.mean(this_buff1[3])
            # ep_reward[1][i][0] = np.mean(this_buff2[3])
